    ...
    <div className="checkoutstep_container">
      <Box sx={{ width: "100%" }}>
        ...
        <div>
          ...
          orderCart.cartProducts.length > 0 ? (
            <React.Fragment>
              <div>
            ...
            <React.Fragment>
              ...
              {activeStep + 1 === 1 ? (
                ...
                <FormControl style={{ width: "100%" }}>
                  <FormLabel component="legend">Credit Card</FormLabel>
                  <TextField
                    name="creditCard"
                    value={creditCard}
                  ...
                  <TextField
                    ...
                    onChange={(e) =>
                      handleInputChange(e, setCreditCardExpiryDate)
                    }
                  />
                ...
                <>
                  ...
                  <h2>Tax: {(cart.cartInfo.totalPrice * 0.13).toFixed(2)}</h2>
